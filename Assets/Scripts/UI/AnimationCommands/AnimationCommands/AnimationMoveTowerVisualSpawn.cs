...
namespace CommandSystem.AnimationCommands
{
    public class AnimationMoveTowerVisualSpawn : AnimationCommand
    {
        ...
        public AnimationMoveTowerVisualSpawn(UIController ui, UpdateGameStatCommand updateGameStatCommand) : base()
        {
        ...
        public AnimationMoveTowerVisualSpawn(UIController ui, CreateRoomCommand createRoomCommand)
        {
            this.ui = ui;
